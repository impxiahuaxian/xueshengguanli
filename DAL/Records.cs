...
namespace Maticsoft.DAL
{
	...
	public partial class Records
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "Records"); 
		}
		...
		public int Add(Maticsoft.Model.Records model)
		{
			...
			strSql.Append("CID,OrderID,Name,Phone,SGRQ,XGRQ)");
			...
			parameters[4].Value = model.SGRQ;
			parameters[5].Value = model.XGRQ;
		...
		public Maticsoft.Model.Records GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,CID,OrderID,Name,Phone,SGRQ,XGRQ from Records ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Records DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Records model=new Maticsoft.Model.Records();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,CID,OrderID,Name,Phone,SGRQ,XGRQ ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,CID,OrderID,Name,Phone,SGRQ,XGRQ ");
			strSql.Append(" FROM Records ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
