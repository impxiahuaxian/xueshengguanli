...
namespace Maticsoft.DAL
{
	...
	public partial class Classes
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "Classes"); 
		}
		...
		public int Add(Maticsoft.Model.Classes model)
		{
			...
			strSql.Append("XB,BH,FDY,Str1)");
			strSql.Append(" values (");
			strSql.Append("@XB,@BH,@FDY,@Str1)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@XB", SqlDbType.NVarChar,50),
					new SqlParameter("@BH", SqlDbType.NVarChar,50),
					new SqlParameter("@FDY", SqlDbType.NVarChar,50),
					new SqlParameter("@Str1", SqlDbType.NChar,10)};
			parameters[0].Value = model.XB;
			parameters[1].Value = model.BH;
			parameters[2].Value = model.FDY;
		...
		public Maticsoft.Model.Classes GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,XB,BH,FDY,Str1 from Classes ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Classes DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Classes model=new Maticsoft.Model.Classes();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,XB,BH,FDY,Str1 ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,XB,BH,FDY,Str1 ");
			strSql.Append(" FROM Classes ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
