...
namespace Maticsoft.DAL
{
	...
	public partial class Course
	{
		...
		public int Add(Maticsoft.Model.Course model)
		{
			...
			strSql.Append("Name,Teacher,XF,SC,Str1)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@XF", SqlDbType.NVarChar,50),
			...
			parameters[2].Value = model.XF;
			parameters[3].Value = model.SC;
		...
		public Maticsoft.Model.Course GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Name,Teacher,XF,SC,Str1 from Course ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Name,Teacher,XF,SC,Str1 ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Name,Teacher,XF,SC,Str1 ");
			strSql.Append(" FROM Course ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
