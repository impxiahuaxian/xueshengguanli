...
namespace Maticsoft.DAL
{
	...
	public partial class Users
	{
		...
		public int Add(Maticsoft.Model.Users model)
		{
			...
			strSql.Append("Phone,UserPSD,UserName,PicID,Age,Sex,Major,Remark,Address,QQ)");
		...
		public Maticsoft.Model.Users GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Phone,UserPSD,UserName,PicID,Age,Sex,Major,Remark,Address,QQ from Users ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Phone,UserPSD,UserName,PicID,Age,Sex,Major,Remark,Address,QQ ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Phone,UserPSD,UserName,PicID,Age,Sex,Major,Remark,Address,QQ ");
			strSql.Append(" FROM Users ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
