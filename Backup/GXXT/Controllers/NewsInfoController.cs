...
namespace MvcApplication2.Controllers
{
    public class NewsInfoController : Controller
    {
        ...
        public ActionResult SManage(Maticsoft.ViewModel.EnjoysSearch model)
        {
            return View(model);
        }

        public PartialViewResult SSearch(Maticsoft.ViewModel.EnjoysSearch model)
        {
            return PartialView(model);
        }

        public PartialViewResult SList(Maticsoft.ViewModel.EnjoysSearch model)
        {
            return PartialView(ebll.Search(model));
        }
